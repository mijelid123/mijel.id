...
const AboutPage: React.FC = () => {
  return (
    <div className="animate-fade-in-down">
      {/* Hero Tentang Kami */}
      <section className="pt-40 pb-20 bg-emerald-900 text-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-emerald-800/50 skew-x-12 transform translate-x-20"></div>
        <div className="container mx-auto px-6 relative z-10 text-center md:text-left">
          <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tighter">Mengenal <span className="text-emerald-400">Mijel.id</span></h1>
          <p className="text-xl text-emerald-100 max-w-2xl leading-relaxed">
            Lebih dari sekadar pengepul, kami adalah gerakan sosial-lingkungan yang berfokus pada penyelamatan ekosistem air Jakarta melalui pengelolaan limbah minyak goreng.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
          <div>
            <span className="text-emerald-600 font-black uppercase tracking-widest text-xs mb-4 block">Cerita Kami</span>
            <h2 className="text-4xl font-black text-slate-900 mb-8 leading-tight">Berawal dari Drainase yang Tersumbat</h2>
            <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
              <p>
                Mijel.id didirikan pada tahun 2023 di Jakarta Barat. Ide ini muncul ketika pendiri kami melihat betapa seringnya banjir melanda kawasan Daan Mogot bukan hanya karena hujan, tapi karena drainase yang tersumbat oleh lemak minyak beku.
              </p>
              <p>
                Minyak jelantah yang dibuang ke wastafel akan membeku di dalam pipa dan selokan, menciptakan "fatberg" yang merusak infrastruktur kota. Kami hadir untuk memberikan solusi: <strong>Ubah limbah menjadi berkah.</strong>
              </p>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-emerald-600 text-white p-8 rounded-3xl shadow-xl">
              ...
              <p className="text-sm font-bold opacity-80 uppercase tracking-widest">Daur Ulang Biodiesel</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white p-12 rounded-[3rem] shadow-xl border border-slate-100">
              <div className="w-16 h-16 bg-emerald-100 rounded-2xl flex items-center justify-center text-emerald-600 text-3xl mb-8">
                <i className="fas fa-eye"></i>
              </div>
              <h3 className="text-3xl font-black text-slate-900 mb-6">Visi</h3>
              <p className="text-slate-600 text-lg leading-relaxed">
                Menjadi platform ekonomi sirkular nomor satu di Indonesia yang mampu mengintegrasikan pengelolaan limbah rumah tangga dengan industri energi terbarukan secara transparan dan menguntungkan.
              </p>
            </div>
            <div className="bg-white p-12 rounded-[3rem] shadow-xl border border-slate-100">
              <div className="w-16 h-16 bg-emerald-100 rounded-2xl flex items-center justify-center text-emerald-600 text-3xl mb-8">
              ...
              <h3 className="text-3xl font-black text-slate-900 mb-6">Misi</h3>
              <ul className="space-y-4 text-slate-600 text-lg">
                <li className="flex gap-4">
                  <i className="fas fa-check-circle text-emerald-500 mt-1"></i>
                  <span>Memberikan edukasi masif tentang bahaya limbah minyak jelantah.</span>
                </li>
                <li className="flex gap-4">
                  <i className="fas fa-check-circle text-emerald-500 mt-1"></i>
                  <span>Membangun jaringan logistik jemput sameday yang efisien di seluruh Jakarta.</span>
                </li>
                <li className="flex gap-4">
                  <i className="fas fa-check-circle text-emerald-500 mt-1"></i>
                  <span>Menjamin harga tertinggi dan transparansi timbangan bagi mitra.</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-black text-slate-900 mb-16">Standar Operasional Kami</h2>
          <div className="grid md:grid-cols-4 gap-8">
            <div className="p-8">
              <div className="text-emerald-600 text-4xl mb-6"><i className="fas fa-fingerprint"></i></div>
              <h4 className="font-black text-slate-800 mb-2">Terdaftar Resmi</h4>
              <p className="text-sm text-slate-500">Memiliki izin pengangkutan limbah non-B3 yang diakui pemerintah.</p>
            </div>
            <div className="p-8">
              <div className="text-emerald-600 text-4xl mb-6"><i className="fas fa-calculator"></i></div>
              <h4 className="font-black text-slate-800 mb-2">Timbangan Digital</h4>
              <p className="text-sm text-slate-500">Kalibrasi rutin untuk memastikan akurasi hingga satuan gram.</p>
            </div>
            <div className="p-8">
              <div className="text-emerald-600 text-4xl mb-6"><i className="fas fa-file-contract"></i></div>
              <h4 className="font-black text-slate-800 mb-2">BAP & Invoice</h4>
              <p className="text-sm text-slate-500">Setiap transaksi disertai bukti tertulis yang sah untuk audit.</p>
            </div>
            <div className="p-8">
              <div className="text-emerald-600 text-4xl mb-6"><i className="fas fa-recycle"></i></div>
              <h4 className="font-black text-slate-800 mb-2">Biodiesel Track</h4>
              <p className="text-sm text-slate-500">Menjamin minyak tidak akan dikonsumsi kembali oleh manusia.</p>
            </div>
          </div>
        </div>
      </section>
    ...
    <div className="min-h-screen selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${isScrolled ? 'glass border-b border-slate-200 py-3 shadow-lg' : 'bg-transparent py-6'}`}>
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10 text-xs font-bold uppercase tracking-widest text-slate-600">
            <button onClick={() => navigateTo('home')} className={`${currentPage === 'home' ? 'text-emerald-600' : 'hover:text-emerald-600'} transition`}>Beranda</button>
            ...
            <button onClick={() => navigateTo('about')} className={`${currentPage === 'about' ? 'text-emerald-600' : 'hover:text-emerald-600'} transition`}>Tentang Kami</button>
      ...
      {currentPage === 'home' ? (
        <div className="animate-fade-in-down">
          ...
          {/* Quick Stats Summary for Home */}
          <section className="py-12 bg-white">
            <div className="container mx-auto px-6">
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div onClick={() => navigateTo('about')} className="cursor-pointer group p-8 rounded-[2rem] hover:bg-emerald-50 transition-all border border-transparent hover:border-emerald-100">
                  <div className="text-emerald-600 text-3xl mb-4 group-hover:scale-110 transition-transform"><i className="fas fa-shield-heart"></i></div>
                  <h4 className="font-black mb-2 text-slate-800">Cegah Pencemaran</h4>
                  <p className="text-sm text-slate-500">Aksi nyata menyelamatkan ekosistem air Jakarta.</p>
                </div>
                <div className="p-8 rounded-[2rem] hover:bg-emerald-50 transition-all border border-transparent hover:border-emerald-100">
                  <div className="text-emerald-600 text-3xl mb-4"><i className="fas fa-money-bill-wave"></i></div>
                  <h4 className="font-black mb-2 text-slate-800">Uang Tunai Instan</h4>
                  <p className="text-sm text-slate-500">Bayar cash atau transfer langsung di tempat.</p>
                </div>
                <div className="p-8 rounded-[2rem] hover:bg-emerald-50 transition-all border border-transparent hover:border-emerald-100">
                  <div className="text-emerald-600 text-3xl mb-4"><i className="fas fa-bolt"></i></div>
                  <h4 className="font-black mb-2 text-slate-800">Layanan Sameday</h4>
                  <p className="text-sm text-slate-500">Pesan pagi, tim kami jemput sebelum sore hari.</p>
                </div>
              </div>
            </div>
          </section>
                  ...
                  <div className="space-y-6 mb-12">
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-500">Kami sediakan jerigen pengganti yang bersih agar operasional dapur tetap lancar.</p>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <div className="w-12 h-12 bg-emerald-500 rounded-full flex-shrink-0 flex items-center justify-center text-white"><i className="fas fa-check"></i></div>
                      <div>
                        ...
                        <p className="text-slate-500">Dokumen lengkap (BAP) untuk kebutuhan audit lingkungan regulasi limbah.</p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-20">
            <div className="md:col-span-2">
              <div onClick={() => navigateTo('home')} className="text-white font-black text-3xl mb-8 tracking-tighter cursor-pointer inline-block">Mijel<span className="text-emerald-500">.id</span></div>
              <p className="text-lg leading-relaxed max-w-sm mb-8">
                Pusat pengumpulan minyak jelantah terpercaya di Jakarta. Layanan Sameday Service (Jakarta) dengan penawaran harga terbaik.
              </p>
              <div className="flex gap-4">
            ...
            <div>
              <h5 className="text-white font-black uppercase tracking-widest text-xs mb-8">Halaman</h5>
              <ul className="space-y-4 text-sm font-bold">
                <li><button onClick={() => navigateTo('home')} className="hover:text-emerald-500 transition">Beranda</button></li>
                <li><button onClick={() => navigateTo('about')} className="hover:text-emerald-500 transition">Tentang Kami</button></li>
                <li><button onClick={() => scrollTo('harga')} className="hover:text-emerald-500 transition">Cek Harga</button></li>
                <li><button onClick={() => scrollTo('siapa')} className="hover:text-emerald-500 transition">Mitra Bisnis</button></li>
              </ul>
            </div>
            <div>
